...
<div class="row contenido">
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-12">
                <strong><h5>Administrar usuarios</h5></strong> <br>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo base_url(); ?>Usuario/Ctrl_Usuario/Registrar" id="Btn_Registrar_Usuario" name="Btn_Registrar_Usuario" class="btn btn-light btn-border"> Registrar usuario</a>
            </div>
        </div>
    </div>
</div><br>
